...
public interface DBInterface {
    ...
    @POST("user/register")
    Call<Account> addAccount(@Field("email") String email, @Field("password") String password);
    ...
    @POST("/quiz")
    @Multipart
    Call<Quiz> addQuiz(@Part("data") Quiz q, @Part("audio") Question.Audio audio, @Part("image") Question.Image image);
